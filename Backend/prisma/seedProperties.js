  ...
  try {
    ...
    const sampleProperties = [
      // NEW DEVELOPMENTS
      {
        ...
        userId: adminUser.id,
        images: {
          principal: principalImages.echoBrickell,
          galeria: galleryImages.echoBrickell
        }
      },
      {
        ...
        userId: adminUser.id,
        images: {
          principal: principalImages.astonMartin,
          galeria: galleryImages.astonMartin
        }
      },
      ...
      // LUXURY CONDOS
      {
        ...
        userId: adminUser.id,
        images: {
          principal: principalImages.fourSeasons,
          galeria: galleryImages.fourSeasons
        }
      },
      ...
      // SINGLE FAMILY HOMES
      {
        ...
        userId: adminUser.id,
        images: {
          principal: principalImages.coralGables,
          galeria: galleryImages.coralGables
        }
      },
      {
        ...
        userId: adminUser.id,
        images: {
          principal: principalImages.coconutGrove,
          galeria: galleryImages.coconutGrove
        }
      },
      ...
      // WATERFRONT PROPERTIES
      {
        ...
        userId: adminUser.id,
        images: {
          principal: principalImages.venetianIslands,
          galeria: galleryImages.venetianIslands
        }
      },
      ...
      // EDGEWATER PROPERTIES
      {
        ...
        userId: adminUser.id,
        images: {
          principal: principalImages.edgewater,
          galeria: galleryImages.edgewater
        }
      },
      ...
      // THE ROADS PROPERTIES
      {
        ...
        userId: adminUser.id,
        images: {
          principal: principalImages.theRoads,
          galeria: galleryImages.theRoads
        }
      }
    ];
    ...
    console.error('❌ Error during properties seed:', error);
    throw error;
  } finally {
