      ...
      <div className={styles.container}>
        ...
        <div className={styles.disclaimerSection}>
          <div className={styles.disclaimer}>
            <p>
              Dayanne Costa is a real estate agent affiliated with Compass.
              Compass is a licensed real estate broker and abides by Equal
              Housing Opportunity laws. All material presented herein is
              ...
              intended to solicit properties already listed. Nothing herein
              shall be construed as legal, accounting or other professional
