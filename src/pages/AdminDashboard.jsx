    ...
    <AdminLayout>
      <div className={styles.dashboard}>
        <div className={styles.header}>
          <h1>Dashboard</h1>
          <p className={styles.subtitle}>Welcome back! Here's what's happening with your properties.</p>
        </div>
        ...
        <div className={styles.statsGrid}>
          <div className={styles.statCard}>
            ...
            <div className={styles.statContent}>
              <div className={styles.statValue}>{dashboardData?.totalProperties || 0}</div>
          ...
          <div className={styles.statCard}>
            <div className={styles.statIcon}>📧</div>
            <div className={styles.statContent}>
              <div className={styles.statValue}>{dashboardData?.totalContacts || 0}</div>
          ...
          <div className={styles.statCard}>
            <div className={styles.statIcon}>👥</div>
            <div className={styles.statContent}>
              <div className={styles.statValue}>{dashboardData?.totalUsers || 0}</div>
              <div className={styles.statLabel}>Total Users</div>
            </div>
            <div className={styles.statChange}>+1 this week</div>
          </div>

          <div className={styles.statCard}>
            <div className={styles.statIcon}>❤️</div>
            <div className={styles.statContent}>
              <div className={styles.statValue}>{dashboardData?.totalFavorites || 0}</div>
